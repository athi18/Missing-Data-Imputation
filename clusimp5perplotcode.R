...
# Load the dataset
df <- read.csv("C:/Users/Sammy/Documents/Missing data/Imputations/5 percent/ClustImpute_5_2024-06-23.csv")

# Define the color palette for the genes
set.seed(123)
unique_genes <- unique(as.vector(df))
