...
df <- read.csv("C:/Users/Sammy/Documents/Missing data/Imputations/5 percent/mice_imp_5_.csv")

# Generate volcano plot for the new dataset and collect significant genes
method_name <- "mice_imp_5"
significant_genes_mice <- generate_volcano_plot_and_collect_genes(df, method_name)
